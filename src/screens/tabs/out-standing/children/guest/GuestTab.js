...
const GuestTab = () => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.likingTitle}>Ai đã ghé thăm hồ sơ của bạn?</Text>
      <Text style={styles.likingDescription}>
        Nếu bạn là Plus có thể xem mọi khách đã ghé thăm. Hãy khám phá ai đã xem hồ sơ của bạn!
      </Text>
      <ScrollView
      ...
      <TouchableOpacity style={styles.buttonShowing}>
        <Text style={styles.buttonShowingText}>Nâng cấp lên Plus</Text>
      </TouchableOpacity>
    </View>
  );
};
